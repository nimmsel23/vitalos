...
export default function Hub({ navigate, openSession, runtimeDate }) {
  return (
          ...
          <div className="flex flex-col gap-8 xl:flex-row xl:items-end xl:justify-between">
            <div className="max-w-3xl">
              ...
              <p className="mt-3 max-w-2xl text-sm text-fit-dim md:text-base">
                Ein gemeinsamer Einstieg f&uuml;r Training, Essen und den Rest der Shell. Die App-internen Dashboards sind nicht mehr dein prim&auml;rer Startpunkt.
              </p>
            </div>
        ...
        <section className="grid gap-6 xl:grid-cols-[1.1fr_0.9fr]">
          ...
          <div className="alpha-card p-6 md:p-8">
            <div className="mb-6 flex items-center gap-3">
              ...
              <div>
                <div className="text-[10px] font-black uppercase tracking-[0.28em] text-fit-dim">Schnellzugriff</div>
